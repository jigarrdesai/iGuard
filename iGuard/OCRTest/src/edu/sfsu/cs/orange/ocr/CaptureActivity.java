...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback,
  ...
  public void onCreate(Bundle icicle) {
    ...
    setContentView(R.layout.capture);
      ...
      imageFilePath=getIntent().getStringExtra(MediaStore.EXTRA_OUTPUT);
      doneButton=(Button) findViewById(R.id.done_button);
      doneButton.setOnClickListener(new View.OnClickListener() {
          @Override
          public void onClick(View view) {
              if(lastBitmap!=null&&storeResultBitmap(lastBitmap)){
                  Intent intent=new Intent();
                  intent.putExtra(Intent.EXTRA_TEXT,ocrResultView.getText().toString());
                  setResult(RESULT_OK,intent);
                  finish();
              }else{
                  Toast.makeText(CaptureActivity.this,"File could not be saved.",Toast.LENGTH_SHORT).show();
              }
          }
      });
  ...
  void showErrorMessage(String title, String message) {
    ...
    private boolean storeResultBitmap(Bitmap bmp){
        boolean success=false;
        FileOutputStream out = null;
        try {
            out = new FileOutputStream(new File(imageFilePath));
